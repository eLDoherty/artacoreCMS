  ...
  return (
	<div className="arta-layout">
	  ...
	  <aside className="arta-layout__sidebar">
          ...
          <li>
            <a href="/admin/posts" className={pathname.startsWith("/admin/posts") ? "active" : ""}>
              Posts
            </a>
          </li>
          <li>
            <a href="/admin/pages" className={pathname.startsWith("/admin/pages") ? "active" : ""}>
              Pages
            </a>
          </li>
          <li>
	  ...
	  <div className="arta-layout__main">
			<header className="arta-header">
				...
				<button className="arta-button arta-button--logout" onClick={handleLogout}>
						Logout
				</button>
			</header>
